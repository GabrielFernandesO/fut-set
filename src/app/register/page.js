    ...
    function togglePassword(){
      ...
      return (
        <main className="bg-blue flex flex-col items-center justify-center h-screen">
            <div className="flex items-center flex-col bg-blue_dark h-9/10 w-1/3 rounded-xl ">
          <div className="text-center mt-20">
            <div className="h-32 w-36  flex-col flex items-center justify-center">
              <Image src={'/logo.png'} width={130} height={64} alt= 'logoRegister'/>
          ...
          <form className={` h-[30rem] w-[40rem] mt-4 flex items-center flex-col space-y-4 form_login`} >
            <div className="flex flex-col mt-20 mb-8 ">
              ...
              <div className="flex items-center w-[15rem] border-b-2 border-gray_weak focus-within:border-gray-300 pl-1">
                <span className="pr-1">
                  <FaRegEnvelope className="text-gray_weak" />
                </span>
                <input type="email"  className="bg-blue_dark h-7 w-64 border-0 outline-none autofill:bg-white" placeholder='Ex: you@example.com'></input>
              </div>
            ...
            <div className="flex flex-col" >
              ...
              <MdOutlineLock className="text-gray_weak text-md" />
                  ...
                  <input type={!showPassword ? "password" : "text"}
                   className="bg-blue_dark h-7 w-64 border-0 outline-none autofill:bg-white" placeholder='Ex: 12345@'></input>
            ...
            <div>
              <button className=" bg-blue h-8 w-28 rounded-lg text-white hover:bg-bege mt-10">
                REGISTER
              </button>
